...
const MyCases = React.lazy(() => import('../pages/Cases/index'))
const NewApplication = React.lazy(
	() => import('../pages/Cases/new-application/index')
)
const Enquiry = React.lazy(() => import('../pages/enquiries/index'))
const Resources = React.lazy(() => import('../pages/resources/index'))
const UpdatePassword = React.lazy(
	() => import('../pages/update-password/index')
)
const UpdateApplication = React.lazy(
	() => import('../pages/Cases/update-application/index')
)
...
const customPagesRoutes = {
	...
	children: [
		...
		{
			path: '/pages/applications/new',
			name: 'New Application',
			element: <NewApplication />,
			route: PrivateRoute,
		},
		{
			path: '/pages/application/update/:id',
			name: 'Update Application',
			element: <UpdateApplication />,
			route: PrivateRoute,
		},
		{
			path: '/pages/enquiry-applications',
			name: 'Enquiry Applications',
			element: <Enquiry />,
			route: PrivateRoute,
		},
		{
			path: '/pages/university-guide',
